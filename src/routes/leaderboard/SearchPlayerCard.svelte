	...
	{#if showCard}
		...
		>
			...
			<div class="flex w-full flex-col">
				<input
					class="h-10 w-full rounded-full border-2 border-transparent bg-galaxy_purple-650 px-4 text-sm font-bold outline-none placeholder:font-normal placeholder:text-galaxy_purple-250 focus:border-galaxy_purple-400 sm:text-base"
