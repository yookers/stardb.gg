...
<main class="flex h-full justify-center py-10">
	<div class="w-[1100px] rounded-xl border-2 border-galaxy_purple-150/95 bg-galaxy_purple-150 p-10 text-galaxy_purple-750">
		...
		<p>
			...
			information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Interpretation and Definitions</h1>

		<h2 class="pt-3 text-xl font-bold">Interpretation</h2>
		...
		<h2 class="pt-3 text-xl font-bold">Definitions</h2>
		...
		<li>
			...
			means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors
			or other managing authority.
		</li>

		<li>
			<strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to StarDB.gg.
		</li>
		...
		<li>
			<strong>Website</strong> refers to StarDB.gg, accessible from
			<a href="https://stardb.gg/" rel="noreferrer noopener" target="_blank">https://stardb.gg/</a>
		</li>
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Collecting and Using Your Personal Data</h1>

		<h2 class="pt-3 text-xl font-bold">Types of Data Collected</h2>

		<h3 class="pt-2.5 text-lg font-bold">Personal Data</h3>
		...
		<h3 class="pt-2.5 text-lg font-bold">Usage Data</h3>
		...
		<h3 class="pt-2.5 text-lg font-bold">Tracking Technologies and Cookies</h3>
		...
		<li>
			...
			to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service
			may use Cookies.
		</li>

		<li>
			<strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web
			beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count
		...
		<li>
			<strong>Necessary / Essential Cookies</strong> Type: Session Cookies Administered by: Us Purpose: These Cookies are essential
			to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate
			users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided,
			and We only use these Cookies to provide You with those services.
		</li>

		<li>
			<strong>Cookies Policy / Notice Acceptance Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies
			identify if users have accepted the use of cookies on the Website.
		</li>

		<li>
			<strong>Functionality Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow us to remember
			choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these
			Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You
			use the Website.
		</li>
		...
		<h2 class="pt-3 text-xl font-bold">Use of Your Personal Data</h2>
		...
		<li>
			...
			of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets
			transferred.
		</li>
		...
		<h2 class="pt-3 text-xl font-bold">Retention of Your Personal Data</h2>
		...
		<h2 class="pt-3 text-xl font-bold">Transfer of Your Personal Data</h2>
		...
		<h2 class="pt-3 text-xl font-bold">Delete Your Personal Data</h2>
		...
		<h2 class="pt-3 text-xl font-bold">Disclosure of Your Personal Data</h2>

		<h3 class="pt-2.5 text-lg font-bold">Business Transactions</h3>
		...
		<h3 class="pt-2.5 text-lg font-bold">Law enforcement</h3>
		...
		<h3 class="pt-2.5 text-lg font-bold">Other legal requirements</h3>
		...
		<h2 class="pt-3 text-xl font-bold">Security of Your Personal Data</h2>
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Children’s Privacy</h1>
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Links to Other Websites</h1>
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Changes to this Privacy Policy</h1>
		...
		<h1 class="pb-1 pt-4 text-xl font-bold underline">Contact Us</h1>
