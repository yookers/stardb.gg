...
<div class="space-y-2 rounded-xl border-2 border-galaxy_purple-650 p-2 transition-all duration-300 sm:hover:translate-y-1">
				...
				<div class="flex justify-between px-5 pb-2">
					...
					<div class="flex items-center justify-center space-x-4">
						...
						<div
							...
							class:bg-galaxy_purple-600={achievementGroup.completed_group_id &&
