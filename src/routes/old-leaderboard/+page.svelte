<script>
    ...
    import { currentInterface } from '../store.js';
...
<div class="flex justify-center text-xs md:text-sm px-2">
	<div class="flex flex-col text-off_white">
        { $currentInterface }
        <p>StarDB.gg Leaderboard</p>
		<!-- Region filter section -->
		<div class="flex flex-col md:flex-row justify-between space-y-4 md:space-y-0 md:space-x-6 py-6 pl-16 pr-12 md:pr-24">
			<div class="flex flex-col space-y-2">
				<p class="line-clamp-1 pl-1 font-bold">Region Filter</p>
			...
			<div class="flex flex-col space-y-2">
				<p class="pl-1 font-bold">Add Player UID</p>
				<AddPlayer on:addplayer={updateAddPlayerNotification} />
			</div>
		</div>
		<!-- Leaderboard section -->
		<div class="flex justify-center">
			<div class="mt-0.5 flex flex-col py-6 font-bold">
				<p class="pb-2">Rank</p>
			...
			<div class="flex-col sm:px-6 pl-4">
				<div class="rounded-lg border-2 border-purple_highlight bg-space_light px-4 py-6 md:px-6">
					<table
						class="w-full table-fixed text-left text-off_white sm:w-[410px] md:w-[510px] lg:w-[780px]"
					>
						<thead>
							<tr>
								<!-- Region indicator -->
								<th class="w-3 md:w-5" />
								<th class="w-8 pb-2 md:w-12">Name</th>
								...
								<th class="w-6 truncate px-2 pb-2 md:w-14 text-center">Achievements</th
								>
							</tr>
						</thead>
						<tbody>
				...
				<!-- Footer information -->
				<div class="pb-8 pl-4 pt-4 md:pl-6">
					<p>
			...
			<!-- Pagination buttons -->
			<div class="flex-col space-y-3 pt-14 fixed right-10 bottom-24 sm:static">
				<button
				...
				>
					<Icon src={ChevronUp} mini class="h-6 w-6 text-off_white" />
				</button>
				<div class="flex justify-center text-xl font-bold select-none">
				...
				>
					<Icon src={ChevronDown} mini class="h-6 w-6 text-off_white" />
				</button>
			</div>
		</div>
	</div>
